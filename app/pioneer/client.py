        ...
        payload = await self._request(
            ...
            json={
                ...
                "domain_description": (
                    ...
                    "covers unwanted alerts. find_content covers locating saved items. "
                    "app_help covers navigation inside an app. possible_scam covers remote "
                    "access, impersonation, gift cards, payment demands, or secret codes. "
